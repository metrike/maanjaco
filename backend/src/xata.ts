  ...
  },
  {
    ...
    columns: [
      ...
      },
      {
        ...
        notNull: true,
        unique: true,
        defaultValue: "nextval('bb_b514smqj4l03v7teo30g4h9nfg_jqn2c4.users_id_seq'::regclass)",
        comment: '',
      },
      {
        name: 'password',
  ...
  },
  {
    ...
    columns: [
      ...
      },
      {
        ...
        notNull: true,
        unique: true,
        defaultValue: "nextval('bb_b514smqj4l03v7teo30g4h9nfg_jqn2c4.websites_id_seq'::regclass)",
        comment: '',
      },
      {
        name: 'limit',
  ...
  },
  {
    ...
    checkConstraints: {
      works_type_check: {
        ...
        columns: ['type'],
        definition: "CHECK ((type = ANY (ARRAY['MANGA'::text, 'MANHWA'::text, 'NOVEL'::text])))",
      },
    },
    foreignKeys: {},
    primaryKey: ['id'],
    ...
    columns: [
      ...
      },
      {
        ...
        notNull: true,
        unique: true,
        defaultValue: "nextval('bb_b514smqj4l03v7teo30g4h9nfg_jqn2c4.works_id_seq'::regclass)",
        comment: '',
      },
      {
...
const defaultOptions = {
  databaseURL: 'https://metrike-s-workspace-jqn2c4.us-east-1.xata.sh/db/manjaco',
}
